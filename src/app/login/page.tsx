        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription className="text-center">
              Accede para calificar y participar en la competencia
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {/* Login Anónimo - Opción Rápida */}
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground text-center">
                Acceso rápido sin necesidad de crear cuenta
              </p>
            </div>
            ...
            {/* Login con Email - Para usuarios registrados */}
            ...
            <p className="text-xs text-center text-muted-foreground">
              Al continuar, aceptas participar en la competencia de forma anónima
            </p>
          </CardContent>
        </Card>
      </main>
